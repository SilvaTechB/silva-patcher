package app.silva.patcher.util

import app.silva.patcher.patch.BytecodePatchContext
import app.silva.patcher.util.ClassMerger.Utils.asMutableClass
import app.silva.patcher.util.ClassMerger.Utils.filterAny
import app.silva.patcher.util.ClassMerger.Utils.filterNotAny
import app.silva.patcher.util.ClassMerger.Utils.isPublic
import app.silva.patcher.util.ClassMerger.Utils.toPublic
import app.silva.patcher.util.ClassMerger.Utils.traverseClassHierarchy
import app.silva.patcher.util.proxy.mutableTypes.MutableClass
import app.silva.patcher.util.proxy.mutableTypes.MutableClass.Companion.toMutable
import app.silva.patcher.util.proxy.mutableTypes.MutableField
import app.silva.patcher.util.proxy.mutableTypes.MutableField.Companion.toMutable
import app.silva.patcher.util.proxy.mutableTypes.MutableMethod
import app.silva.patcher.util.proxy.mutableTypes.MutableMethod.Companion.toMutable
